...
switch($lang){
 case 'ja':
  ...
  $map = "parkingmap2022.png";
  $parking = "駐車場";
  $yakeyama_parking = "焼山駐車場（計420台）";
  $yasumiya_parking = "休屋駐車場（計640台）";
  $parking1 = "十和田湖温泉スキー場１";
  $parking2 = "十和田湖温泉スキー場２";
  $parking3 = "休屋北駐車場";
  $parking4 = "休屋南駐車場";
  break;
 case 'en':
  ...
  $parking1 = "Towada Lake Onsen (hot spring) Ski Resort １";
  $parking2 = "Towada Lake Onsen (hot spring) Ski Resort ２";
 ...
 case 'co':
  ...
  $parking1 = "도와다호 온천스키장１";
  $parking2 = "도와다호 온천스키장２";
  $parking3 = "야스미야 북문주차장";
  $parking4 = "야스미야 남문주차장";
  break;
 case 'chi':
  ...
  $parking1 = "十和田湖温泉 滑雪场１";
  $parking2 = "十和田湖温泉 滑雪场２";
  $parking3 = "休屋北停车场";
  $parking4 = "休屋南停车场";
  break;
 case 'tchi':
...
開車前來奧入瀨溪流者，請將車輛停泊於<span class="color_navy">燒山停車場（免費）或休屋停車場（收費）</span>內之後再搭乘<span class="color_navy">觀光班車（收費）</span>至目的地。
<?php } else if ($lang=='en'){?>
...
<?php } else {?>
シャトルバス運行期間は、「エコロード区間」への車両の進入はお控えください。<br>
<strong>奥入瀬渓流へマイカー・観光バス等でお越しの際は、<span class="color_navy">焼山駐車場（無料）・休屋駐車場（有料）</span>に駐車の上、<span class="color_navy">シャトルバス（有料）</span>をご利用ください</strong>
<?php } ?>
</div>
<div class="text_r">▶<a href="<?php echo $site_url;?>/<?php echo $lang;?>/bus-ship--2022#timetable" class="td_n color_blk">
<?php if ($lang=='co'){?>
셔틀버스 시간표 보기
<?php } else if ($lang=='chi'){?>
请按此参阅观光班车时间表
...
yakeyama_pos = [[40.577738, 140.993337],[40.578344, 140.992288],[40.577582, 140.994194]];
yakeyama_title = ['<?php echo $parking1;?>','<?php echo $parking2;?>'];
yakeyama_icon = ['ico_p1.gif','ico_p2.gif'];
