...
switch($lang){
 ...
 case 'en':
  ...
  $text_1 = "Adults 1,430 yen";
  $text_2 = "Children 720 yen";
...
開車前來奧入瀨溪流者，請將車輛停泊於<span class="color_navy">燒山停車場（免費）或休屋停車場（收費）</span>內，然後再搭乘<span class="color_navy">觀光班車（收費）</span>至目的地。
<?php } else if ($lang=='en'){?>
...
<?php } else if ($lang=='tchi'){ ?>
<strong>・2019年10月24日（週四）・10月25日（週五）<div class="disp_ib">【首班】9:00～【末班】14:30</div></strong>
<?php } ?>
</div>
</div>
...
<?php } else if ($lang=='tchi'){ ?>
<strong>・2019年10月26日（週六）・10月27日（週日）<div class="disp_ib">【首班】8:00～【末班】15:20</div></strong>
<?php } ?>
</div>
</div>
<div class="right-inner parents" style="padding-top: 0;">
...
<?php } else if ($lang=='tchi'){?>
首班與末班之間<span style="color: #336600;">每隔20分鐘一班</span>
<?php } else if ($lang=='en'){?>
...
<div style="clear: both; border: solid 2px #ff0000; padding: 10px 20px; margin-bottom: 20px; font-weight: bold;">
