...
<p>Laungage<img src="<?php echo $site_url;?>/pages/images<?php echo $new;?>/down-arrow.png" alt="" class="float_r"></p>
<ul>
...
<p class="float_l">・</p><p class="ovf_h"><span><?php echo $menu[$lang][3];?></span></p>
</a>
