...
<div id="header_wrapper">
 <div id="header">
  <ul>
   <li><a href="<?php echo $site_url;?>/ja" class="hf">日本語</a></li><li><a href="<?php echo $site_url;?>/co" class="hf">한국어</a></li><li><a href="<?php echo $site_url;?>/en" class="hf">English</a></li><li><a href="<?php echo $site_url;?>/chi" class="hf">中国語</a></li>
  </ul>
 </div>
<?php if ($page!=''){ ?>
 <div id="subheader">
