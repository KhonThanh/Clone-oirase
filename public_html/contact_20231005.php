...
・JR버스 아오모리지점 0177-23-1621
<?php } else if ($lang=='chi'){?>
・十和田观光电铁 0176-23-3131<br />
・JR巴士青森分店  017-723-1621
<?php } else if ($lang=='tchi'){?>
・十和田觀光電鐵 0176-23-3131<br>
・JR巴士青森分店  017-723-1621
<?php } else if ($lang=='en'){?>
・Towada sightseeing railroad<span class="disp_ib">　0176-23-3131</span><br />
・JR bus Aomori branch　017-723-1621
<?php } else {?>
・十和田観光電鉄　0176-23-3131<br />
・ＪＲバス青森支店　017-723-1621
<?php } ?>
</p>
<br />
<p><strong>○<?php echo $title_4;?></strong><br />
<?php if ($lang=='co'){?>
・코한택시(호반)  0176-75-2617<br />
・오이라세택시(야케야마)  0176-74-2206
<?php } else if ($lang=='chi'){?>
・湖畔出租车（湖畔）　0176-75-2617<br />
・奥入濑出租车（烧山） 0176-74-2206
<?php } else if ($lang=='tchi'){?>
・湖畔計程車（湖畔）　0176-75-2617<br>
・奥入濑計程車（燒山） 0176-74-2206
<?php } else if ($lang=='en'){?>
・Kohan taxi (Kohan)　0176-75-2617<br />
・Oirase taxi (Yakeyama)　0176-74-2206
<?php } else {?>
・湖畔タクシー（湖畔）　0176-75-2617<br />
・奥入瀬タクシー（焼山）　0176-74-2206
<?php } ?>
</p>
</div>
 </div>
