...
switch($lang){
 case 'ja':
  $footer = '奥入瀬十和田利活用協議会・奥入瀬渓流</span><span class="disp_ib">エコツーリズムプロジェクト実行委員会';
  break;
 case 'en':
  $footer = ' Oirase Towada Utilization Council・</span><span class="disp_ib">Oirase Stream Eco-Tourism Project Executive Comittee';
  break;
 case 'co':
  $footer = '오이라세 도와다 활용협의회・</span><span class="disp_ib">오이라세계류 에코투어리즘 프로젝트실행위원회';
  break;
 case 'chi':
  $footer = '奥入濑十和田利活用协议会、</span><span class="disp_ib">奥入濑溪流生态旅游规划实行委员会';
  break;
 case 'tchi':
  $footer = '奧入瀨十和田利活用協議會・</span><span class="disp_ib">奧入瀨溪流生態旅遊規劃實行委員會';
  break;
}
?>
</div>
...
<?php if ($page!='lp_project'){ ?>
  ...
  <ul>
   ...
   <li><a href="<?php echo $site_url;?>/<?php echo $lang;?>/parking"><?php echo $menu[$lang][4];?></a></li>
   <li><a href="<?php echo $site_url;?>/<?php echo $lang;?>/bus-ship"><?php echo $menu[$lang][5];?></a></li>
   <li><a href="<?php echo $site_url;?>/<?php echo $lang;?>/faq"><?php echo $menu[$lang][6];?></a></li>
  </ul>
  <ul>
   <li><a href="<?php echo $site_url;?>/<?php echo $lang;?>/walking"><?php echo $menu[$lang][7];?></a></li>
   <?php if($lang=='ja') :?>
   <li><a href="<?php echo $site_url;?>/<?php echo $lang;?>/activity"><?php echo $menu[$lang][8];?></a></li>
   <li><a href="<?php echo $site_url;?>/<?php echo $lang;?>/team"><?php echo $menu[$lang][9];?></a></li>
   <?php endif;?>
  </ul>
  </div>
  <div class="fmenu">
  <ul>
   <li><a href="<?php echo $site_url;?>/<?php echo $lang;?>/access"><?php echo $menu[$lang][10];?></a></li>
   <li><a href="<?php echo $site_url;?>/<?php echo $lang;?>/contact"><?php echo $menu[$lang][11];?></a></li>
   <li><a href="<?php echo $site_url;?>/<?php echo $lang;?>/link"><?php echo $menu[$lang][12];?></a></li>
  </ul>
  <?php if($lang=='ja') :?>
  <ul>
